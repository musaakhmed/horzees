        ...
        <div className='bg-page bg-contain  bg-blend-darken bg-cyan-50 bg-opacity-100'>
            ...
            <section className='flex flex-'>
                <div className='flex flex-col pt-24 pl-12 md:pl-24 lg:pl-36 xl:pl-48 w-2/3 items-start justify-start'>
                    <div className='text-[#A44A3F]'>
                        <h1 className='text-3xl lg:text-6xl font-extrabold h2-shadow font-avenir py-2 '>
                            The Art
                        </h1>
            ...
            <section>
                <div className='flex gap-6 flex-row mx-auto justify-center items-center w-5/6 lg:w-1/2 py-4'>
                    <img
                        className='h-[100px] w-[100px] lg:h-[250px] lg:w-[250px] rounded-3xl border-3 border-solid border-slate-900 shadow-lg transform -rotate-3 hover:rotate-0 transition-all duration-200 ease-in-out'
                        src='/images/art/sketches/1-a.jpg'
                    />
                    <img
                        className='h-[100px] w-[100px] lg:h-[250px] lg:w-[250px] rounded-3xl border-3 border-solid border-slate-400 shadow-lg transform rotate-1 hover:rotate-0 transition-all duration-200 ease-in-out'
                        src='/images/art/sketches/1-b.jpg'
                    />
                    <img
                        className='h-[100px] w-[100px] lg:h-[250px] lg:w-[250px] rounded-3xl border-3 border-solid border-slate-400 shadow-lg transform rotate-6 hover:rotate-0 transition-all duration-200 ease-in-out'
                        src='/images/art/sketches/2-a.jpg'
                    />
                </div>
                <h2 className='flex gap-6 flex-row mx-auto justify-center items-center text-semibold h2-shadow w-5/6 lg:w-1/2 font-avenirstdlt py-16 text-lg lg:text-2xl text-[#A44A3F]'>
                ...
                <div className='flex gap-6 flex-row mx-auto justify-end items-center w-5/6 lg:w-1/2 py-4'>
                    ...
                    />
                    <img
                        className='h-[100px] w-[100px] lg:h-[250px] lg:w-[250px] rounded-3xl border-3 border-solid border-slate-400 shadow-lg transform rotate-3 hover:rotate-0 transition-all duration-200 ease-in-out'
                ...
                <div className='flex gap-6 flex-row mx-auto justify-center items-center w-5/6 lg:w-1/2 py-4'>
                    ...
                    />
                    <img
                        className='h-[100px] w-[100px] lg:h-[250px] lg:w-[250px] rounded-3xl border-3 border-solid border-slate-400 shadow-lg transform rotate-2 hover:rotate-0 transition-all duration-200 ease-in-out'
                ...
                <div className='flex gap-6 flex-row mx-auto justify-end items-center w-5/6 lg:w-1/2 py-4'>
                    <img
                        className='h-[100px] w-[100px] lg:h-[250px] lg:w-[250px] rounded-3xl border-3 border-solid border-slate-400 shadow-lg -rotate-6 hover:rotate-0 transition-all duration-200 ease-in-out'
            ...
            <section className='flex gap-2 flex-col mx-auto justify-center items-center w-5/6 lg:w-1/2 py-4'>
                <div className='flex gap-2 flex-row mx-auto justify-center items-center w-5/6 lg:w-1/2'>
                    <img
                        className='lg:grayscale opacity-90 lg:hover:opacity-100 lg:hover:grayscale-0 h-[100px] w-[100px] lg:h-[250px] lg:w-[250px] rounded-lg border-3 border-solid border-slate-400 shadow-md transition-all duration-200 ease-in-out'
                    ...
                    />
                    <img
                        className='lg:grayscale opacity-90 lg:hover:opacity-100 lg:hover:grayscale-0 h-[100px] w-[100px] lg:h-[250px] lg:w-[250px] rounded-lg border-3 border-solid border-slate-400 shadow-lg transition-all duration-200 ease-in-out'
