...
const Navbar = () => {
    ...
    const [menuOpen, setMenuOpen] = useState(false)
    const genericHamburgerLine = `h-1 w-6 my-0.5 rounded bg-teal-700
    ...
    return (
        <nav className='flex flex-col md:px-10 pt-6'>
            <section className='flex justify-between items-center px-2 pb-6 md:hidden '>
                <span className='font-avenirnext h2-shadow text-xl text-teal-700 font-semibold'>
                    horzees
                </span>
                <button
            ...
            {/* <button
                className='inline-flex p-3 hover:bg-gray-600 rounded md:hidden text-slate-500 ml-auto hover:text-white outline-none transition-all duration-300 ease-in-out'
                onClick={handleClick}
            >
                <svg
                    className='w-6 h-6'
            ...
            >
                <div className='text-xl min-h-screen bg-white bg-opacity-70 md:bg-transparent flex flex-col md:flex-wrap flex-1 md:flex-row justify-center md:justify-end items-center md:px-5 font-semibold md:font-extralight font-avenirnext h2-shadow '>
                    <Link href='/'>
                    ...
                    <Link href='https://discord.gg/horzeesnft'>
                        <a className='bg-teal-500 hover:bg-teal-700 md:bg-transparent md:hover:bg-transparent transition-all duration-300 ease-in-out py-2 my-4 px-8 rounded-lg md:py-0 md:px-2 flex-shrink-0 object-contain object-center'>
                            <svg
                                className='stroke-teal-500 hover:stroke-teal-200 transition-all duration-200 ease-in-out opacity-50 hover:animate-bounce'
                                fill='#000000'
                                xmlns='http://www.w3.org/2000/svg'
                                viewBox='0 0 50 50'
                                width='25px'
                    ...
                    <Link href='https://twitter.com/Horzees'>
                        <a className='bg-teal-500 hover:bg-teal-700 md:bg-transparent md:hover:bg-transparent transition-all duration-300 ease-in-out py-2 my-4 px-8 rounded-lg md:py-0 md:px-2 flex-shrink-0 object-contain object-center'>
                            <svg
                                className='stroke-teal-500 hover:stroke-teal-200 transition-all duration-300 ease-in-out opacity-50 hover:animate-bounce'
                                fill='#000000'
                                xmlns='http://www.w3.org/2000/svg'
                                viewBox='0 0 50 50'
                                width='25px'
